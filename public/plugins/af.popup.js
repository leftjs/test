...
(function($) {
	...
	var popup = (function() {
		...
		popup.prototype = {
			...
			show : function() {
				var self = this;
				var markup = '<div id="' + this.id + '" class="afPopup hidden ' + this.addCssClass + '">' + '<header>' + this.title + '</header>' + '<div>' + this.message + '</div>' + '<footer style="clear:both;">' + '<a href="javascript:;" class="' + this.cancelClass + '" id="cancel">' + this.cancelText + '</a>' + '<a href="javascript:;" class="' + this.doneClass + '" id="action">' + this.doneText + '</a>' + ' </footer>' + '</div></div>';
